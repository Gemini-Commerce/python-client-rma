...
class TestRmaListReturnsResponse(unittest.TestCase):
    """RmaListReturnsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RmaListReturnsResponse:
        """Test RmaListReturnsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RmaListReturnsResponse`
        """
        model = RmaListReturnsResponse()
        if include_optional:
            return RmaListReturnsResponse(
                returns = [
                    rma.models.rma_return_response.rmaReturnResponse(
                        id = '', 
                        grn = '', 
                        order_grn = '', 
                        status = '', 
    ...
    def testRmaListReturnsResponse(self):
        """Test RmaListReturnsResponse"""
